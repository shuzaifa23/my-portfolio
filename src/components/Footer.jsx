  ...
  return (
    <footer className="bg-[#111111] text-[#d4d4d4] py-16 px-6 md:px-12 w-full font-mono text-[10px] md:text-xs tracking-widest flex flex-col justify-between min-h-[50vh]">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-12 md:gap-8 w-full items-end font-medium">
        {/* Left Column: Contact, Email & Social Links */}
        <div className="flex flex-col gap-4">
          <a href="#contact" className="underline hover:text-white transition-colors underline-offset-4 decoration-1 font-bold text-sm">Contact</a>
        ...
        <div className="flex flex-col gap-3 md:items-center">
          <p className="text-[#d4d4d4] font-mono text-[10px] md:text-xs text-center max-w-xs opacity-90">
