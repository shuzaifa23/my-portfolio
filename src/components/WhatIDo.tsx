    ...
    I focus on clean code, performance, and real-world problem solving.
          ...
          >
            ...
            <div className="what-content-in">
              ...
              <h4>Description</h4>
              <p>
            Building intelligent systems using Generative AI to create text, automate workflows,
            and solve real-world problems using LLMs, APIs, and modern AI tools.  
              </p>
              <h5>Skillset & tools</h5>
              <div className="what-content-flex">
                ...
                <div className="what-tags">expression</div>
                <div className="what-tags">node.js</div>
                <div className="what-tags">NLP</div>
                <div className="what-tags">flasl</div>
              </div>
              <div className="what-arrow"></div>
            </div>
          </div>
